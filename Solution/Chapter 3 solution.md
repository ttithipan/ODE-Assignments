...
>
> $$
> \mathcal{L}\{\sinh t\} = \frac{1}{2} \left[ \frac{e^{-(s-1)t}}{-(s-1)} - \frac{e^{-(s+1)t}}{-(s+1)} \right]_0^\infty = \frac{1}{2} \left( \frac{1}{s-1} - \frac{1}{s+1} \right)
> $$
>
> $$
> = \frac{1}{2} \left(\frac{s+1 - (s-1)}{s^2-1}\right) = \frac{1}{s^2-1} \quad (s > 1)
> $$
...
>
> $$
> \mathcal{L}\{f(t)\} = \frac{1}{2}\mathcal{L}\{1\} + \frac{1}{2}\mathcal{L}\{\cos(4t)\} = \frac{1}{2s} + \frac{s}{2(s^2+16)}
> $$
>
> $$
> = \frac{s^2+16+s^2}{2s(s^2+16)} = \frac{s^2+8}{s(s^2+16)}
> $$
...
>
> $$
> \mathcal{L}\{f(t)\} = \frac{1}{2} \mathcal{L}\{\cosh(6t)\} - \frac{1}{2}\mathcal{L}\{1\} = \frac{1}{2} \frac{s}{s^2-36} - \frac{1}{2s}
> $$
>
> $$
> = \frac{s^2 - (s^2-36)}{2s(s^2-36)} = \frac{18}{s(s^2-36)}
> $$
...
>
> $$
> \mathcal{L}\{f(t)\} = \left[ -\frac{t}{s}e^{-st} \right]_0^1 + \frac{1}{s} \int_0^1 e^{-st} dt
> $$
>
> $$
> = -\frac{1}{s}e^{-s} - \frac{1}{s^2}e^{-s} + \frac{1}{s^2} = \frac{1 - e^{-s}(1+s)}{s^2}
> $$
